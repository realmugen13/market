...
//         <div class="products__barcode">${item.barcode}</div>
//         <div class="products__mark">${item.mark}</div>
//         <div class="products__brand">${item.brand}</div>
//         <div class="products__price">Цена: ${item.price}$</div>
//         <div class="product__button">
//           <button data-id="${item.id}">добавить</button>
//         </div>
//       </div>
//     `
//   })
...
//           <div class="cart-product__barcode">${item.barcode}</div>
//           <div class="cart-product__mark">${item.mark}</div>
//           <div class="cart-product__brand">${item.brand}</div>
